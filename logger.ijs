...
coclass 'logger'
coinsert 'base'
require 'gtkwd'#~-.'Library: 8.' +./ . E. JVERSION
NB. require 'winapi' NB. winlib'  NB.  dt'
...
NB. getTempPath=: 'GetTempPath' win32api
...
getTempDir=: 3 : 'PATHSEP_j_,~>1{(USERFOLDERS_j_,a:;PATHSEP_j_,''Temp''){~({."1 USERFOLDERS_j_)i.<''Temp'''
